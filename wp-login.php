...
<link rel="preload" href="./wp-includes/css/dashicons.min.css?ver=6.2.2" as="style" id="dashicons" media="all" onload="this.onload=null;this.rel='stylesheet'">
<noscript>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.2.2" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/reformaslider/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acceder">
									<input type="hidden" name="redirect_to" value="http://localhost/reformaslider/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a href="./?action=lostpassword">¿Has olvidado tu contraseña?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Ir a Reformas Lider</a>		</p>
			</div>
...
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/reformaslider\/wp-admin\/admin-ajax.php"}};</script>
<script src="./wp-includes/js/wp-util.min.js?ver=6.2.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"1aaea6b352"};</script>
